    ...
    <div class="flex flex-col w-full gap-3 px-2 md:w-1/2">
        ...
        <div>
            <ul class="flex justify-between w-full">
                <a href="{{route('forum')}}"  class="flex justify-center w-full border-b-2 border-gray-300">
                    Forums
                </a>
                @if(Auth::user()->course !== null)
                <a href="{{route('department-forum')}}"  class="flex justify-center w-full ml-1 border-b-2 {{request()->is('department-forums')?' text-blue-600 border-blue-300':'text-gray-500 border-gray-300'}}">
                   Department Forums
                </a>
                @endif
            </ul>
        ...
        <div class="fixed md:hidden bottom-0 left-0 z-50 w-full h-16 bg-green-900 border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
