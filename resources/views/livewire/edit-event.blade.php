<div class="flex justify-center pt-2 md:items-center md:justify-center">
    <div class="flex flex-col w-full gap-3 px-2 md:w-1/2">
        ...
        <h1 class="mb-3 font-bold text-center">Edit Event</h1>
        <div >
            <form wire:submit="update">
                {{ $this->form }}

                <button  wire:click="$refresh" type="submit" class="mt-5 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-green-700 rounded-lg focus:ring-4 focus:ring-gree-200 dark:focus:ring-gree-900 hover:bg-gree-800">
                    Edit Event
                </button>
