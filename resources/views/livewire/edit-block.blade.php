<div class="relative flex justify-center pt-3 h-dvh md:items-center md:justify-center">
    <div class="flex flex-col w-full gap-3 px-2 md:w-1/2">
        <div class="flex items-center justify-between w-full ">
            <a href="{{route('block',['id'=>$year_id])}}" class="font-bold text-red-500">
        ...
        <h1 class="mb-3 font-bold text-center">Edit Block</h1>
        <div class="mb-3">
