<div class="relative flex justify-center pt-2 overflow-scroll h-dvh md:items-center md:justify-center">
        ...
        <div class="w-full ">
         ...
         <div>
            <ul class="flex justify-between w-full">
                ...
                <a href="{{route('organization-account')}}" wire:navigate class="flex justify-center w-full ml-1 border-b-2 border-gray-300">
                    Organization
                 </a>
                <a href="{{route('request')}}" wire:navigate class="flex justify-center w-full border-b-2  {{request()->is('request')?' text-blue-600 border-blue-300':'text-gray-500 border-gray-300'}}">
                    Request
                 </a>
            </ul>
        </div>
