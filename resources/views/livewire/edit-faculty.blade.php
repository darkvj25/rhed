    ...
    <div class="flex flex-col w-full gap-3 px-2 md:w-1/2">
        ...
        <div >
            <form wire:submit="update">
                ...
                <button  wire:click="delete" type="button" class="mt-5 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-red-700 rounded-lg focus:ring-4 focus:ring-red-200 dark:focus:ring-red-900 hover:bg-red-800">
                    Delete
                </button>
