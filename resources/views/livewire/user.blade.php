        ...
        <div class="w-full ">
         ...
         <div>
            <ul class="flex justify-between w-full">
                <a href="{{route('user')}}" wire:navigate class="flex justify-center w-full border-b-2 {{request()->is('users')?' text-blue-600 border-blue-300':'text-gray-500 border-gray-300'}}">
                   Students
                </a>
