<div >
    <div class="mt-2">
        <ul class="flex justify-between w-full">
            <a href="{{route('register')}}" wire:navigate class="flex justify-center w-full border-b-2 border-gray-300">
               Students
            </a>
            <a href="{{route('register-faculty')}}" wire:navigate class="flex justify-center w-full ml-1 border-b-2 {{request()->is('register-faculty')?' text-blue-600 border-blue-300':'text-gray-500 border-gray-300'}}">
                Faculty
             </a>
