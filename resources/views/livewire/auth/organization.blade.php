<div >
    <div class="mt-2">
        <ul class="flex justify-between w-full">
            ...
            <a href="{{route('organization')}}" wire:navigate class="flex justify-center w-full ml-1 border-b-2 {{request()->is('organization')?' text-blue-600 border-blue-300':'text-gray-500 border-gray-300'}}">
                Org.
             </a>
        </ul>
    </div>
