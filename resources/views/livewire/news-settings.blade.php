        ...
        <div class="flex flex-col gap-3 "style="padding-bottom: 100px;" >
           ...
           <div  id="dropdownDots{{$new->id}}" class="z-10 hidden w-40 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                    ...
                    <li class="mb-2">
                        <a href={{route('edit-News',['id'=>$new->id])}} class="block px-4 py-2 text-center text-white bg-green-500 rounded-lg hover:bg-green-400 ">Edit</a>
                    </li>
                    <li>
            ...
            <div class="flex items-center justify-center w-full">
                <h1 class="relative text-xl font-bold text-gray-300">No news found...</h1>
            </div>
            @endforelse
