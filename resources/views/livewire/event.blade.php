    ...
    <div class="flex flex-col w-full gap-3 px-2 md:w-1/2">
        ...
        <div>
            <ul class="flex justify-between w-full">
                <a href="{{route('event')}}"  class="flex justify-center w-full border-b-2  {{request()->is('events')?' text-blue-600 border-blue-300':'text-gray-500 border-gray-300'}}">
                    Events
                </a>
                @if(Auth::user()->course !== null)
                <a href="{{route('department-event')}}"  class="flex justify-center w-full ml-1 border-b-2 border-gray-300">
                   Department Events
                </a>
                @endif
            </ul>
