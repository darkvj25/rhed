    ...
    <div class="flex flex-col w-full gap-3 px-2 md:w-1/2">
        ...
        <div>
            <ul class="flex justify-between w-full">
                <a href="{{route('news')}}"  class="flex justify-center w-full border-b-2 border-gray-300">
                   News
                </a>
                <a href="{{route('course-news')}}"  class="flex justify-center w-full ml-1 border-b-2 {{request()->is('course-news')?' text-blue-600 border-blue-300':'text-gray-500 border-gray-300'}}">
                   Department News
                </a>
            </ul>
        </div>
        ...
        <div class="flex flex-col h-full gap-3 "style="padding-bottom: 100px;" >

            @forelse ($news as $new)
            <div class="flex justify-center w-full " >
                    <div class="relative block w-full max-w-lg px-6 py-3 bg-white border border-gray-200 rounded-lg shadow ">
                        ...
                        <div class="absolute right-0 top-1 ">
                            <button id="dropdownMenuIconButton{{$new->id}}" data-dropdown-toggle="dropdownDots{{$new->id}}" data-dropdown-placement="bottom-start" class="inline-flex items-center self-center p-2 text-sm font-medium text-center text-gray-900 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-white-50 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-600" type="button">
           ...
           <div  id="dropdownDots{{$new->id}}" class="z-10 hidden w-40 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                    ...
                    <li class="mb-2">
                        <a href={{route('edit-News',['id'=>$new->id])}} class="block px-4 py-2 text-center text-green-500 bg-green-500 rounded-lg hover:bg-grenn-400 ">Edit</a>
                    </li>
                    <li>
