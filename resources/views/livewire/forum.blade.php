<div class="px-4 mt-2">
    ...
    <div class="flex items-center justify-between py-4">
        ...
        <h1 class="text-xl font-bold text-white">University Forum</h1>
    ...
    <div wire:loading.remove class="space-y-4 pb-24">
        @forelse ($forums as $forum)
            ...
            @endphp
            @if(Auth::user()->role === 'admin' || (is_array($year) && in_array(intval(Auth::user()->year), $year)) || $forum->user_id === Auth::user()->id)
